...
Config.user_realm = "hes-so.ch"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam.hes-so.ch']
Config.use_other_tls_id = False
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

Stj2lVbeCn8Q9OsHayHwY1jCQwVVIO2yGMaei8FLt7uE
-----END CERTIFICATE-----
"""
run_installer()
